...
# Fetch Bank of America's current stock price
ticker = 'BAC'
data = yf.Ticker(ticker)
current_price = data.history(period='1d')['Close'].iloc[-1]

# Parameters for the Black-Scholes model
S = current_price  # Current stock price of Bank of America (BAC)
K = 30  # Strike price (you can change this value)
...
# Print the results
print(f"Bank of America (BAC) Current Stock Price: {S:.2f}")
...
# Bank of America (BAC) Current Stock Price: 29.45
# Strike Price: 30
# Time to Expiration (years): 1.10
# Risk-Free Interest Rate: 0.05
# Volatility: 0.30
# Call Option Price: 2.85
# Put Option Price: 3.33